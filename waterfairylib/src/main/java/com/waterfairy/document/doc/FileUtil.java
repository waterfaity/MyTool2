...
public class FileUtil {
    ...
    public static String createFile(String sdcard_path, String dir_name, String file_name) {
        if (sdcard_path == null) {
            sdcard_path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download";
        }
