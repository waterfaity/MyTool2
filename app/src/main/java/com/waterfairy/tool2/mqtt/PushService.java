...
public class PushService extends Service {
    ...
    public static String MQTT_HOST = "192.168.1.216";
    // the port at which the broker is running.
    public static int MQTT_BROKER_PORT_NUM = 61616;
...
//        handleCrashedService();
    ...
    private synchronized void connect() {
        ...
        mPrefs.edit().putString(PREF_DEVICE_ID, "android_id").apply();
